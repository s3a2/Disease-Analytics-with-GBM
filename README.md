...
* HealthcareAnalytics.ipynb implements the multi-class GBM model to **identify which health metric features most strongly predict diabetes, hypertension, asthma, arthritis, cancer, and obesity** in medical patients prior to their hospital stay. This works:
